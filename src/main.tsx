...
ReactDOM.render(
  <div id="wrap">
        ...
        <div className="machine">
          ...
          <div className="pay_area">
            ...
            <div className="wallet" id="_wallet">
              ...
              <ul>
                <li>
                  <div className="w50 _drag_able"><span className="blind">50원</span></div>
                </li>
                <li>
                  <div className="w100 _drag_able"><span className="blind">100원</span></div>
                </li>
                <li>
                  <div className="w500 _drag_able"><span className="blind">500원</span></div>
                </li>
                <li>
                  <div className="w1000 _drag_able"><span className="blind">1,000원</span></div>
                </li>
              </ul>
              <p className="my_money">지금 내 돈: <span>10,000</span>원</p>
            </div>
          </div>
    ...
    {/*<!-- footer --> */}
    <div id="footer">
      <address><strong>Vending Machine</strong></address>
    </div>
    {/*<!-- //footer --> */}
  </div>,
